...
import { getPipelineRun, cancelPipelineRun, submitPipelineApproval, triggerPipelineRun } from '../../api/project/pipeline';
  ...
  return (
    <PipelineRunDetailView
      ...
      onReplay={async params => {
        ...
        const result = await triggerPipelineRun(Number(repoId), params);
